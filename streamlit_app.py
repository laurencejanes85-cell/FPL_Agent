...
# ── Landing / auth page ───────────────────────────────────
if not st.session_state.authenticated and st.session_state.free_questions_used == 0 and not st.session_state.show_auth and not st.session_state.get("free_mode", False):
    st.markdown(f"""
    <div class="hero">
